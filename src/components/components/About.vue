  ...
  <section id="about" data-color="bg--blue-dark" class="about">
    <div class="row">
      <div class="col-10 offset-1">
        <h2 data-aos="slide-up-heading" class="d-split about__title">
          The story so far
        </h2>
      </div>
      <div class="col-10 offset-1 col-xl-8 offset-xl-2">
        ...
        >
          ...
          <span class="hover-item">
            ...
            >London
          </span>, fuelled by creative designs, clean code,
          <span class="hover-item">
          ...
          >
            <div class="align-items-end row">
              <div class="col-12 col-lg-4">
                <p class="about__timeline-body">{{ item.startDate }} &mdash; {{ item.endDate }}</p>
              </div>
              <div class="col-12 col-lg-4">
    ...
    <div class="row">
      <div class="col-10 offset-1 col-xl-3 offset-xl-2">
        <h4 class="about__subtitle">Technical Skills</h4>
      </div>
      <div class="col-10 offset-1 col-xl-6 offset-xl-1">
      ...
      <div class="col-10 offset-1 col-xl-6 offset-xl-1">
        <div class="about__skills-list">
          <ul>
            ...
            <li>
              <p data-aos="reveal">Mobile first and responsive design</p>
            </li>
            <li>
            ...
            <li>
              <p data-aos="reveal">GIT / Bitbucket code versioning tools</p>
            </li>
            <li>
              <p data-aos="reveal">Web Accessibility</p>
            </li>
            <li>
